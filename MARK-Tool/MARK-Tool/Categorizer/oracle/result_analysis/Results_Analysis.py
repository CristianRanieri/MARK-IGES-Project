...
# in entrambi aggiunge una colonna, rispettivamente Is ML Producer e Is ML Consumer.
...
def main():
    ...
    oracle_df = pd.read_csv("../oracle_producer_new.csv")
    ...
    # Path to the folder containing Producers_1 CSV files
    producers_folder = "../../src/Producers/Producers_3"
    ...
    # Save the resulting dataframe to a new CSV file
    result_df.to_csv("result_producer_3.csv", index=False)
    ### Third Dataset ###
    ...
    # Load the oracle.csv file
    oracle_df = pd.read_csv("../oracle_consumer_new.csv")
    ...
    # Path to the folder containing Producers_1 CSV files
    producers_folder = "../../src/Consumers/Consumers_6"
    ...
    for filename in os.listdir(producers_folder):
        if filename.endswith(".csv"):
            ...
            result_df.loc[matching_projects, "is ML Consumer"] = "Yes"
    # Save the resulting dataframe to a new CSV file
    result_df.to_csv("result_consumer_6.csv", index=False)
    ### Sixth Dataset ###
